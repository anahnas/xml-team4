...
insert into car(car_model_id, car_class_id, fuel_type_id, transmission_id, waiver, limited_kms, location_id, available_child_seats)
...
insert car_rating(rating, user_id, car_id, comment, rating_status) values ( 3.1, 1, 1, 'Odlicno!', 1);
