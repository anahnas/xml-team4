...
values (1, 1, 1, 1, 1, 'true', 30, 'true', 1, 2, 2500.45, 123.45, 333.33, 33.33, 1);
insert into car(car_brand_id, car_model_id, car_class_id, fuel_type_id, transmission_id, waiver, waiver_price_per_day, limited_kms, location_id, available_child_seats, price_per_day, price_per_km, limit_kms_per_day, kmage, owner_id)
values (2, 2, 2, 2, 2, 'false', 0, 'true', 2, 1, 453.55, 122.55, 787.88, 33.33, 1);
insert into car(car_brand_id, car_model_id, car_class_id, fuel_type_id, transmission_id, waiver, waiver_price_per_day, limited_kms, location_id, available_child_seats, price_per_day, price_per_km, limit_kms_per_day, kmage, owner_id)
values (1, 1, 1, 1, 1, 'true', 20, 'true', 1, 2, 2500.45, 123.45, 333.33, 33.33, 2);
insert into car(car_brand_id, car_model_id, car_class_id, fuel_type_id, transmission_id, waiver, waiver_price_per_day, limited_kms, location_id, available_child_seats, price_per_day, price_per_km, limit_kms_per_day, kmage, owner_id)
values (1, 1, 1, 1, 1, 'false', 0, 'true', 1, 2, 2500.45, 123.45, 333.33, 33.33, 2);
